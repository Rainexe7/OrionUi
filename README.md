...
Orion.Name = "Explicit Hub <Orion Lib>"
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Explicit Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Explicit Hub"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
	  OrionLib:MakeNotification({Name = "Explicit Hub",Content = "Destroy Script..." ,Image = "rbxassetid://",Time = 5})task.wait(1)
	  Orion:Destroy()
	end)

	OrionLib:MakeNotification({Name = "Explicit Hub",Content = "Execute Script..." ,Image = "rbxassetid://",Time = 5})
